...
export default function PropertyDetailsClient({ property }) {
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      title: property?.title || 'Property from Occupra',
  ...
  const baseUrl = process.env.NEXT_PUBLIC_API_URL ? process.env.NEXT_PUBLIC_API_URL.replace('/api', '') : 'http://localhost:5050';

  return (
    <div className="details-page-root" style={{ paddingTop: '60px' }}>
      <Navbar />
      ...
      <div className="details-container">
        <div className="flex-col gap-8 animate-fade-in">
          ...
          <div className="flex-between items-center sm:px-4">
            ...
            >
              <ArrowLeft size={16} />
              <span className="font-bold text-xs uppercase tracking-widest ml-2">Back to Discovery</span>
            </button>
            ...
            <div className="lg:col-span-7 flex-col gap-10">
              <div className="property-hero-preview">
                {property.images && property.images.length > 0 ? (
                  <ImageWithSkeleton
                    src={property.images[0].startsWith('http') ? property.images[0] : `${baseUrl}${property.images[0]}`}
                    alt={property.title}
              ...
              <div className="tactical-sidebar-node">
                ...
                <div className="console-card !p-8 !bg-slate-900 border-none flex items-center gap-6 group hover:scale-[1.02] transition-all shadow-xl">
                  ...
                  <div className="flex-col gap-1">
                    ...
                    <p className="text-slate-400 text-[10px] font-black uppercase tracking-tight font-sans">Active since {new Date(property.createdAt).toLocaleDateString('en-GB')}.</p>
                  </div>
                </div>
