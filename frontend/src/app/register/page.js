...
import { User, Home, AlertCircle, Phone, Mail, Lock, ShieldCheck } from 'lucide-react';
...
export default function Register() {
  ...
  const [passwordStrength, setPasswordStrength] = useState({ score: 0, label: 'Empty', color: '#e5e7eb' });

  const { firebaseAuth, register } = useAuthStore();
